...
class WalletTest(MoneyTreeXETestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MXE from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 MXE in block rewards plus fees, but
        ...
        # Send 10 MXE with subtract fee from amount
        ...
        # Sendmany 10 MXE with subtract fee from amount
