...
By default, moneytreexed will dump mempool on shutdown and
...
class MempoolPersistTest(MoneyTreeXETestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give moneytreexed a second to reload the mempool
        ...
        self.log.debug("Prevent moneytreexed from writing mempool.dat to disk. Verify that `savemempool` fails")
