...
//
//     src/qt/test/test_moneytreexe-qt -platform xcb      # Linux
//     src/qt/test/test_moneytreexe-qt -platform windows  # Windows
//     src/qt/test/test_moneytreexe-qt -platform cocoa    # macOS
void TestGUI()
{
