...
# TestNode: A peer we use to send messages to moneytreexed, and store responses.
...
class CompactBlocksTest(MoneyTreeXETestFramework):
    ...
    # This test actually causes moneytreexed to (reasonably!) disconnect us, so do this last.
    ...
    # moneytreexed's choice of nonce.
    ...
    # Test that moneytreexed requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for moneytreexed to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # moneytreexed will not send blocktxn responses for blocks whose height is
